...
// ⚔️ 통합 배틀 판정 로직
    async function runBattle(playerA, playerB) {
        ...
        2. 능력 설정과 상성: 능력의 파괴력 및 상대방의 능력을 카운터 치는 속성 상성(50%)
        3. 실제 능력치 (힘/민첩/지력): 스탯의 총합과 분배가 전투에 미치는 물리적/마법적 영향(20%)
        4. 강화 횟수: 강화 레벨에 따른 압도적인 등급 차이(20%)
        ...
        1. 두 전사의 격돌을 반드시 박진감 넘치지만 무조건 3문장 이내로 아주 간결하게 묘사한다. 상대방의 능력은 구체적으로 설명은 하지 않는다.
        2. 전투 묘사 바로 다음 줄에 한 줄 띄우고, 가운데 정렬해서 [승자: 이름] 형식으로 승자의 이름만 정확히 출력한다.`;
